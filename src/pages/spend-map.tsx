...
// Dynamically import inner map to avoid SSR issues
const SpendMapInner = dynamic(() => import("../components/spend/SpendMapInner"), { ssr: false });

export default function SpendMapPage() {
